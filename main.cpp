...
struct Student
{
  ...
  string name;
  bool library = true;
  bool department_head = true;
  bool students_affair = true;
  bool sports_and_clubs = true;
  bool college_admin = true;
  bool dining =true;
  bool dormitory = true;
  void menu();
  bool registrar;
...
again:
  ...
  srchh:
    ...
    break;
  case 4:
      cout << "Enter the name of the stundent you want to add: ";
      getline(cin, name);
      
      temp->name = name;
      temp->id = to_string(stoi(Student_table[Student_table.size() - 1]->id) + 1);
...
wrong_choice:
  ...
  getline(cin, action);std::cout << "\033[2J\033[1;1H";
 // cin.ignore();
